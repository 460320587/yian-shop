...
beforeEach(() => {
  getMyReviewsMock = vi.fn(() => Promise.resolve({
    data: [
      { id: 1, product_id: 1, rating: 5, content: '质量很好', reply: null, reply_at: null, created_at: '2026-01-01', product: { id: 1, name: '名片', thumbnail: '/img/card.jpg' } },
      { id: 2, product_id: 2, rating: 4, content: '不错', reply: '感谢您的评价', reply_at: '2026-01-02', created_at: '2026-01-02', product: { id: 2, name: '宣传单', thumbnail: null } },
    ],
