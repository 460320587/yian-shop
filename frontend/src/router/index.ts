...
const routes: RouteRecordRaw[] = [
  {
    ...
    children: [
      ...
      { path: '/points', name: 'Points', component: () => import('@/views/points/PointsView.vue'), meta: { requiresAuth: true } },
      { path: '/tickets', name: 'TicketList', component: () => import('@/views/ticket/TicketListView.vue'), meta: { requiresAuth: true } },
      { path: '/ticket-create', name: 'TicketCreate', component: () => import('@/views/ticket/TicketCreateView.vue'), meta: { requiresAuth: true } },
      { path: '/samples', name: 'SampleList', component: () => import('@/views/sample/SampleListView.vue'), meta: { requiresAuth: true } },
      { path: '/pay-password', name: 'PayPassword', component: () => import('@/views/payment/PayPasswordView.vue'), meta: { requiresAuth: true } },
      { path: '/invoices', name: 'InvoiceList', component: () => import('@/views/invoice/InvoiceListView.vue'), meta: { requiresAuth: true } },
      { path: '/invoice-apply', name: 'InvoiceApply', component: () => import('@/views/invoice/InvoiceApplyView.vue'), meta: { requiresAuth: true } },
  ...
  { path: '/forgot-password', name: 'ForgotPassword', component: () => import('@/views/auth/ForgotPasswordView.vue'), meta: { guest: true } },
  {
    ...
    children: [
      ...
      { path: 'enterprise-auths', name: 'AdminEnterpriseAuths', component: () => import('@/views/admin/EnterpriseAuthManagementView.vue'), meta: { title: '企业认证' } },
      { path: 'admins', name: 'AdminAccounts', component: () => import('@/views/admin/AdminAccountManagementView.vue'), meta: { title: '管理员账号' } },
      { path: 'roles', name: 'AdminRoles', component: () => import('@/views/admin/RoleManagementView.vue'), meta: { title: '角色权限' } },
      { path: 'production-schedules', name: 'AdminProductionSchedules', component: () => import('@/views/admin/ProductionScheduleManagementView.vue'), meta: { title: '生产排期' } },
      { path: 'articles', name: 'AdminArticles', component: () => import('@/views/admin/ArticleManagementView.vue'), meta: { title: '文章管理' } },
    ],
  },
